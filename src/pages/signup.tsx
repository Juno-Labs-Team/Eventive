...
export default function Signup() {
  const { user, signUpWithEmail, signInWithGoogle, signInWithDiscord, loading } = useAuth();
  ...
  return (
    <div className="login-container">
      <div className="login-box">
        ...
        <p className="login-subtitle">Join Eventive today</p>
        ...
        <div className="oauth-buttons">
          ...
          <button onClick={handleDiscordSignIn} className="oauth-button discord-button">
